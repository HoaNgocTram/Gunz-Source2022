					 ...
					 const MMatchSex nSex, const int nHair, const int nFace)
{
	...
	// Custom: Ignore List erase
	if( ZGetGameClient()->IsUserIgnored( m_szCharName ) )
		ZGetGameClient()->SetIgnoreUser( m_szCharName, false );
...
bool ZMyInfo::InitAccountInfo(const char* szAccountID, MMatchUserGradeID nUGradeID, MMatchPremiumGradeID nPGradeID, int nCountryFlag, int nCash, int nEvent)
{
