...
void ZActorActionSummon::ProcessSummon(const MUID& uidOwner, const MUID& uidTarget, int Count, const char* name, const rvector& pos, const rvector& dir, int route, bool bAdjustPlayerNum) const
{
	if (name == "")
	{
