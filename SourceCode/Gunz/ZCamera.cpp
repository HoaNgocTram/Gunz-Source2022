...
void ZCamera::RSetCameraDistance(unsigned short nCameraDistance)
{
	...
	case 2: {	g_nCameraDistance = 420.f;	}	break;
	case 3: {	g_nCameraDistance = 460.f;	}	break;
	case 4: {	g_nCameraDistance = 490.f;	}	break;
	case 5: {	g_nCameraDistance = 500.f;	}	break;
	case 6: {	g_nCameraDistance = 590.f;	}	break;
	case 7: {	g_nCameraDistance = 690.f;	}	break;
	case 8: {	g_nCameraDistance = 790.f;	}	break;
	case 9: {	g_nCameraDistance = 890.f;	}	break;
	case 10: {	g_nCameraDistance = 990.f;	}	break;
