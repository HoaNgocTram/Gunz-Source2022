...
//Custom: Custom Encrypt Old
char Keyz[10] = { 'G', 'u', 'n', 'z', '2', '0', '2', '2', '�', '@' };
void SystemJork(char* pData, int _size)
{
#ifdef _THEMIDACML
	VM_START
#endif
...
///Custom: Custom Encrypt Old
//void SystemJork(char* data, int ent)
//{
//#ifdef _THEMIDACML
//	VM_START
//#endif
//		if (!data) return;
//	char var[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
//	char vector[32] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
//						0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 };
//
//	struct XTS ctx;
//	init_ctx(&ctx, vector, var);
//	ctr(&ctx, data, ent);
//#ifdef _THEMIDACML
//	VM_END
//#endif
...
bool MZip::Initialize(FILE* fp, unsigned long ReadMode)
{
...
#ifndef _ENCRYPTJORK
		SystemJork((char*)&dh, sizeof(MZIPDIRHEADER));
#else
	...
	if (m_nZipMode >= ZMode_Mrs2)
#ifndef _ENCRYPTJORK
		SystemJork((char*)m_pDirData, dh.dirSize);
#else
...
#ifndef _ENCRYPTJORK
		SystemJork((char*)&h, sizeof(h));
		SystemJork(_fileheaderReader, _fileheaderReaderSize);
#else
		RecoveryChar((char*)&h, sizeof(h));
...
#ifndef _ENCRYPTJORK
	SystemJork((char*)pDirData, dir_data_size);
#else
