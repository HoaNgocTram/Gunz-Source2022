...
void CDDBDialog::SetWindowText(LPCTSTR lpszString)
{
	...
	if (m_DlgInfo.bUseTitlebar)
	{
		...
		{
#ifdef LOCALE_NHNUSA
			m_Screen.PutText(1, 1, m_DlgInfo.nWidth, GetY(SIZE_CAPTIONBARDEFAULT), 15, "Tahoma", lpszString, RGB(42, 98, 154), TS_BOLD, DT_CENTER);
			m_Screen.PutText(0, 0, m_DlgInfo.nWidth, GetY(SIZE_CAPTIONBARDEFAULT), 15, "Tahoma", lpszString, RGB(250, 250, 250), TS_BOLD, DT_CENTER);
#else
			m_Screen.PutText(1, 2, m_DlgInfo.nWidth, GetY(SIZE_CAPTIONBARDEFAULT), 15, "Tahoma", lpszString, RGB(0, 0, 0), TS_BOLD, DT_CENTER);
			m_Screen.PutText(0, 1, m_DlgInfo.nWidth, GetY(SIZE_CAPTIONBARDEFAULT), 15, "Tahoma", lpszString, RGB(200, 200, 200), TS_BOLD, DT_CENTER);
#endif
		}
