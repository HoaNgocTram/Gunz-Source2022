						...
						const bool bIsTicketChannel, const DWORD dwTicketItemID, const bool bIsUseTicket, const bool bIsUseEvent, const char* pszNameStrResId)
{
	...
	// 채널룰에 대한 특성들 정의
	if (nType == MCHANNEL_TYPE_PRESET || nType == MCHANNEL_TYPE_DUELTOURNAMENT || nType == MCHANNEL_TYPE_LADDER)
	{
...
bool MMatchChannel::CheckLifePeriod()
{
	...
	if (nType == MCHANNEL_TYPE_PRESET || nType == MCHANNEL_TYPE_DUELTOURNAMENT || nType == MCHANNEL_TYPE_LADDER) return true;
