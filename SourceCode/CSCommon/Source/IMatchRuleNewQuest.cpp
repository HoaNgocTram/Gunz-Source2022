...
#define FILENAME_NPC3_XML		"NewQuest/npc3.xml"
...
{
	if (!ms_actorDefMgr.ReadXml(NULL, FILENAME_NPC3_XML))
	{
		mlog("Read Blitzkriegs NPC3 file %s Failed\n", FILENAME_NPC3_XML);
		_ASSERT(0); return;
	}
	mlog("Read NPC 3 (Blitzkriegs)");
}
