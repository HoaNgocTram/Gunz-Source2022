...
#define CLAN_CREATING_NEED_BOUNTY		2000	// 클랜생성에 필요한 바운티
#define CLAN_CREATING_NEED_LEVEL		10		// 클랜생성에 필요한 레벨


#ifndef _LVL200
#define MAX_CHAR_LEVEL	127
#else
...
// Custom: Updated limits for player count and rounds (16, 100) default
#define STAGE_MAX_PLAYERCOUNT			64  // 기본모드(퀘스트, 클래을 제외) 최대 인원. - by SungE 2007-05-14.
#define STAGE__MAX_ROUND				500	// 스테이지에서 사용할 수 있는 최대 라운드 수. 이수를 넘을 수 없다. - By SungE 2007-11-07
// clan
...
#define MAX_ITEM_COUNT				500			// 한사람이 최대로 갖을 수 있는 아이템 개수(상점에서 아이템 구입시)
