...
protected:	// ∑°¥ÅE
	...
	void OnLadderRequestChallenge(const MUID& uidRequestMember, void* pGroupBlob, unsigned long int nOptions, unsigned long int nGameType);
...
public:
	...
	void OnStartBlitz(MMatchStage* pStage);
protected :
	// Keeper∞ÅE√.
...
public:	
	...
	void LaunchLadderWarsGame(PlayerJoiningDataStruct Data, LadderWars Type, int MapID);
	void UpdateLadderWarsGame(MMatchStage* pStage, MMatchObject* pObj, MMatchTeam nTeam);
	void PostLadderWarsCharInfo(MUID uidPlayer, LadderWarsCharInfo* pLadderCharInfo);
